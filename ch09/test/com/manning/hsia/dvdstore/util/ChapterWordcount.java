...
public class ChapterWordcount {
  ...
  static {
    ...
    excludeList.add("don'");
    excludeList.add("her");
    excludeList.add("puts");
    excludeList.add("an");
    excludeList.add("additional");
    excludeList.add("was");
    excludeList.add("important");
    excludeList.add("have");
    excludeList.add("They");
    excludeList.add("comes");
    excludeList.add("able");
    excludeList.add("with");
    excludeList.add("easy");
    excludeList.add("provided");
    excludeList.add("let's");
    excludeList.add("as");
    excludeList.add("How");
    excludeList.add("To");
    excludeList.add("different");
    excludeList.add("you");
    excludeList.add("several");
    excludeList.add("probably");
    excludeList.add("typical");
    excludeList.add("more");
    excludeList.add("possible");
    excludeList.add("three");
    excludeList.add("no");
    excludeList.add("understand");
    excludeList.add("book");
    excludeList.add("which");
    excludeList.add("because");
    excludeList.add("need");
    excludeList.add("itemizelist");
    excludeList.add("see");
    excludeList.add("fairly");
    excludeList.add("depending");
    excludeList.add("figure");
    excludeList.add("Unfortunately");
    excludeList.add("unfortunately");
    excludeList.add("higher");
    excludeList.add("very");
    excludeList.add("loading");
    excludeList.add("both");
    excludeList.add("It");
    excludeList.add("when");
    excludeList.add("much");
    excludeList.add("end");
    excludeList.add("go");
    excludeList.add("some");
    excludeList.add("mediaobject");
    excludeList.add("make");
    excludeList.add("want");
    excludeList.add("given");
    excludeList.add("they");
    excludeList.add("last");
    excludeList.add("its");
    excludeList.add("them");
    excludeList.add("imageobject");
    excludeList.add("other");
    excludeList.add("first");
    excludeList.add("two");
    excludeList.add("This");
    excludeList.add("could");
    excludeList.add("those");
    excludeList.add("between");
    excludeList.add("into");
    excludeList.add("example");
    excludeList.add("In");
    excludeList.add("quite");
    excludeList.add("has");
    excludeList.add("such");
    excludeList.add("lot");
    excludeList.add("using");
    excludeList.add("your");
    excludeList.add("up");
    excludeList.add("these");
    excludeList.add("chapter");
    excludeList.add("what");
    excludeList.add("would");
    excludeList.add("does");
    excludeList.add("do");
    excludeList.add("each");
    excludeList.add("use");
    excludeList.add("so");
    excludeList.add("common");
    excludeList.add("most");
    excludeList.add("know");
    excludeList.add("if");
    excludeList.add("provide");
    excludeList.add("very");
    excludeList.add("also");
    excludeList.add("emphasis");
    excludeList.add("only");
    excludeList.add("their");
    excludeList.add("than");
    excludeList.add("used");
    excludeList.add("fileref");
    excludeList.add("but");
    excludeList.add("imagedata");
    excludeList.add("full");
    excludeList.add("png");
    excludeList.add("might");
    excludeList.add("I");
    excludeList.add("about");
    excludeList.add("through");
    excludeList.add("way");
    excludeList.add("xref");
    excludeList.add("needs");
