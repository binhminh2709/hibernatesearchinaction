...
public final class MoreLikeThis {
  ...
  public static void main(String[] a) throws Throwable {
    ...
    // this is for the ueser to set up we did not do this for the book
    // this class is created and used by the TestMoreLikeThis test
  ...
  private void addTermFrequencies(Reader r, Map termFreqMap, String fieldName)
    ...
    while ((token = ts.next(token)) != null) { // for every token
